...
class RegisterViewController: UIViewController {
    ...
    @objc private func registerButtonTapped(){
        ...
        DatabaseManager.shared.userExists(with: email, completition: { [weak self] exists in
    ...
    func alertUserLoginError(message:String = "Please Enter The All credential to register"){
...
extension RegisterViewController:UIImagePickerControllerDelegate,UINavigationControllerDelegate{
    ...
    func presentPhotoActionSheet() {
        let actionSheet = UIAlertController(title: "Profile Picture", message: "Select Profile Picture", preferredStyle: .actionSheet)
